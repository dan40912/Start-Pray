const en = {
  ...
  site: {
    nav: {
      ...
      anonymousHint: "No account needed to pray",
  ...
  home: {
    prayerHero: {
      ...
      uploaderLabel: "Shared by",
      uploaderAnonymous: "Anonymous",
    ...
    companion: {
      ...
      emptyPlaylist: "There is nothing to play right now.",
      removeFromPlaylist: "Remove from playlist",
      moreOptions: "More options",
      report: "Report",
      reportConfirm: "Report this prayer response?",
      reportConfirmYes: "Yes, report it",
      reportConfirmNo: "Cancel",
      reportSending: "Sending report…",
      reportSuccess: "Reported. This content will no longer be shown.",
    ...
    recorder: {
      ...
      chooseTitle: "How would you like to be with this person?",
      chooseText: "Write a few words",
      chooseTextHint: "No account needed. Eight characters is enough.",
      chooseVoice: "Record your voice",
      chooseVoiceHint: "Up to 60 seconds. Needs microphone access.",
      chooseVoiceDenied: "Your browser is blocking the microphone. You can still write.",
      chooseVoiceUnsupported: "This browser cannot record. You can still write.",
      textTitle: "Write your prayer",
      textPlaceholder: "It does not need to be long. One honest sentence is enough.",
      textSubmit: "Send written prayer",
      textTooShort: "A few more characters (at least 8).",
      textTooLong: "That is over 2000 characters. Please shorten it.",
      meterActive: "Picking up sound",
      meterSilent: "No sound yet",
      noSoundYet: "No sound yet — check whether the microphone is muted.",
      ...
      deniedBody: "Please allow microphone access in your browser settings and try again.",
      retry: "Try again",
      back: "Back",
      unsupportedTitle: "This browser does not support recording yet.",
      unsupportedBody: "Please use a newer version of Safari, Chrome, or Edge.",
      recordingLabel: "Recording",
      remainingLabel: "Remaining",
      seconds: "s",
      stop: "Stop recording",
      previewLabel: "Recording preview",
      play: "Play",
      pause: "Pause",
      ...
      listenAnother: "Listen to someone else's prayer",
      ...
      rerecordConfirmYes: "Yes, record again",
      rerecordConfirmNo: "Keep this recording",
      tooShort: "Say a little more before finishing",
      errorDeviceTitle: "A recording device error occurred.",
      errorDeviceBody: "Please reload the page or try a different browser.",
